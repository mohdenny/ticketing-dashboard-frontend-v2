...
export default function EditTicketPage() {
  ...
  const handleUpdateSubmit = async (
    ...
    try {
      ...
      router.push('/operasional/tickets');
    } catch (err) {
  ...
  if (error)
    return (
      <div className="flex flex-col items-center justify-center min-h-[50vh] space-y-4">
        ...
        <CancelAction link="/operasional/tickets" label="Kembali ke Daftar" />
      </div>
    );
  ...
  if (!ticket)
    return (
      <div className="text-center py-20">
        ...
        <CancelAction link="/operasional/tickets" label="Kembali" />
      </div>
    );
    ...
    <div className="max-w-7xl mx-auto py-8 px-4 md:px-8">
      ...
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 mb-8">
        ...
        <div className="flex-shrink-0">
          <CancelAction link="/operasional/tickets" label="Batal & Kembali" />
        </div>
      </div>
