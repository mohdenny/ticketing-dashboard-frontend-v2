...
import { useMaintenance, useMaintenanceDetail } from '@/hooks/useMaintenance';
...
export default function EditMaintenancePage({
  ...
  const handleSubmit = async (formData: any, historyData?: any) => {
    try {
      ...
      router.push('/operasional/tickets/maintenance');
    } catch (e) {
    ...
    <div className="min-h-screen bg-[#FDFCFF] p-6 md:p-8">
      <div className="max-w-5xl mx-auto space-y-6">
        <PageTitle
          ...
          actionButton={{
            link: 'link="/operasional/tickets/maintenance',
            label: 'Buat Tiket',
          }}
        />
