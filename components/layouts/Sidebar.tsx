...
export default function Sidebar() {
  ...
  const menuGroups = [
    ...
    },
    {
      ...
      groupIcon: LifeBuoy,
      items: [
        { name: 'Daftar Tiket', href: '/tickets', icon: Ticket },
    ...
    },
    {
      ...
      groupIcon: Wrench,
      items: [
        { name: 'Daftar Permintaan', href: '/maintenance', icon: ListTodo },
        {
        ...
        {
          name: 'Pengecekan Rutin',
          href: '/maintenance/routine',
          icon: ShieldCheck,
        },
      ],
    },
    ...
    },
    {
      ...
      items: [
        ...
        {
          name: 'Kualitas Siaran',
          href: '/complaints/broadcast',
          icon: RadioTower,
        },
        {
          name: 'Kritik & Saran',
