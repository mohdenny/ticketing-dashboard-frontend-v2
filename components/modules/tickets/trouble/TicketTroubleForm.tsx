...
import {
  ticketTroubleSchema,
  TicketTroubleFormValues,
} from '@/schemas/ticketTroubleSchema';
import {
  Save,
  Send,
  Loader2,
...
export default function TicketTroubleForm({
  initialData,
  onSubmit,
  isLoading,
  ...
  const {
    ...
    trigger,
    formState: { errors },
  } = useForm<TicketTroubleFormValues | any>({
    resolver: zodResolver(ticketTroubleSchema),
    defaultValues: {
